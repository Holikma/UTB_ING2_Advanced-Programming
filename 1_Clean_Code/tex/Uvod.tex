...
Tento problém je obzvlášť aktuálny v prostredí agilného vývoja, kde je prioritou rýchle dodávanie hodnoty používateľovi. Prílišná orientácia na architektonickú čistotu môže spomaľovať vývoj, zvyšovať komplexnosť systému a odvádzať pozornosť od skutočných potrieb používateľov. Teda výskumná otázka tejto práce znie:
